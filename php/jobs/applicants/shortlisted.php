...
$query = "SELECT u.name,  u.login_name FROM applications a INNER JOIN users u ON a.login_name = u.login_name  WHERE a.job_id = $jobId AND shortlisted = 1 ORDER By a.id LIMIT $preLimit, $noOfItemsPerPage ";
